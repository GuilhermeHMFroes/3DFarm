  ...
  return (
    ...
    <div  className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        {activePrinters.map(printer => (
            ...
            <Card key={printer.id} className="overflow-hidden !border-2 !border-green-500 shadow-lg shadow-green-500/20 min-h-96 max-h-96">
        ...
        {idlePrinters.map(printer => (
            ...
            <Card key={printer.id} className="overflow-hidden !border-2 !border-blue-500 shadow-lg shadow-blue-500/20 min-h-96 max-h-96">
                <div className="flex justify-between items-center mb-2 p-2">
        ...
        {(disconnectedPrinters.length > 0 && idlePrinters.length === 0 && activePrinters.length === 0) ? (
            ...
            <div>
                {disconnectedPrinters.length > 0 && (
                    ...
                    <Card className="overflow-hidden !border-2 !border-red-500 shadow-lg shadow-red-500/20 min-h-96 max-h-96">
